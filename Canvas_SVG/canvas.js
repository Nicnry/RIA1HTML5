var canvas = document.getElementById("myCanvas");   // var canvas = document.querySelector('canvas'); Autre méthode
...
// Square
c.fillStyle = '#e94f37';
c.fillRect(150, 200, 500, 500);                 //fillRect(x: int, y: int, largeur: int, hauteur: int)


// Circle
c.fillStyle = '#393e41';
// c.strokeStyle = '#e94f37';
c.arc(1000, 475, 250, 0, Math.PI * 2, false)    // Draw a circle. arc(x: int, y: int, r: int, startAngle: float, endAngle: float, drawCounterClockwise: bool)
...
c.moveTo(1300, 700);                            // Point de départ 130;700
